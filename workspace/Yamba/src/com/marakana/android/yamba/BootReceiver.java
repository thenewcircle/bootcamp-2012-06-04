...
public class BootReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		// Register with the AlarmManager to trigger the UpdaterService on a repeating basis.
		Intent startUpdaterService = new Intent(context, UpdaterService.class);
		PendingIntent pi = PendingIntent.getService(context, 1, startUpdaterService, 
